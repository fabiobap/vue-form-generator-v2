...
let resources = {
	...
	invalidFormat: "O formato é inválido.",

	numberTooSmall: "O número deve ter no mínimo {0}.",
	numberTooBig: "O número deve ter no máximo {0}.",
	invalidNumber: "O número é inválido.",
	invalidInteger: "É necessário informar um valor inteiro.",

	textTooSmall: "Deve conter no mínimo {1} caracteres. (atual{0}).",
	textTooBig: "O texto deve ser de no máximo {1}. (atual{0}).",
	thisNotText: "É necessário informar um texto.",

	thisNotArray: "O valor não é uma coleção.",
	...
	invalidPasswordConfirmation: "As senhas não conferem",
};
...
const validators = {
	...
	passwordConfirmation(value, field, model, messages = resources) {
		let res = checkEmpty(value, field.required, messages);
		if (res != null) return res;
